...
function App() {
  ...
  const fetchBooks = () => {
    fetch('https://bookstore-9c11d-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://bookstore-9c11d-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`, {
      method: 'DELETE',
    })
      .then((response) => fetchBooks())
      .catch((err) => console.error(err));
